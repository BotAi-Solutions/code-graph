 ...
 * a `node_modules` tree. They are deliberately thin: the analyzers read import
 * specifiers and syntax, not types.
 */
...
declare module 'bullmq' {
  export class Queue {
    ...
    add(jobName: string, payload: unknown): Promise<{ id: string }>;
    close(): Promise<void>;
  }
